 ...
 * Includes header, metadata, hero image, architecture details, and highlights.
 */
...
/**
 * Icon rotation for highlights
 */
const highlightIcons = [Shield, Zap, Globe];
  ...
  return (
    ...
    >
      <div className="container-main">
        ...
        <Link
          to="/#projects"
          className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] mb-12"
        >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 mb-16">
          ...
          {links?.demo && (
            <a
              ...
              className="btn btn-primary rounded-full px-8 py-4 font-bold flex items-center gap-3 shrink-0 group"
            >
              See the system live
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {/* Category */}
          <div className="bento-card p-6 rounded-[var(--radius-xl)]">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[var(--color-accent-primary)] text-[10px] font-bold uppercase tracking-widest">
                // CATEGORY //
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {highlights.map((highlight, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bento-card p-8 min-h-[180px] flex flex-col justify-between"
                >
